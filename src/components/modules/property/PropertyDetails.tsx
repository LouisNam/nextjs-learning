...
function renderFacilityIcon(item: [string, any]): React.ReactNode {
  ...
  const Icon = dynamic(
    () => import(`../../../components/icons/Icon${newName}`)
  );
  return (
    <>
      <span>
        ...
        <div className="grid grid-cols-[2fr_1fr] gap-6">
          <div aria-label="left">
            ...
            <div>
              ...
              <h3 className="text-lg font-medium mb-7">Fatality</h3>
          ...
          <div aria-label="right" className="flex flex-col gap-5">
            <div
              aria-label="agent"
              className="flex flex-col items-center justify-center px-6 py-4 border rounded-lg border-grayF4 bg-grayFC"
            >
